...
\subsubsection{Sala de ensayo}
    Para la sala de ensayo, se determinaron parámetros como $RT_{mid}$ y claridad, parámetros que se compararon con los recomendados en la siguiente tabla. (ver tabla \ref{tab:parametros acusticos sala ensayo}).
    \begin{table}[H]
        \centering
        \begin{tabular}{|l|c|c|}
        \hline
